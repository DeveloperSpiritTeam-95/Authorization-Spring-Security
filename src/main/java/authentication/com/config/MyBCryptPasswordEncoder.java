...
public class MyBCryptPasswordEncoder implements MyPasswordEncoder{
    ...
    public MyBCryptPasswordEncoder(BCryptPasswordEncoder.BCryptVersion version) {
        this(version, (SecureRandom)null);
    }

    public MyBCryptPasswordEncoder(BCryptPasswordEncoder.BCryptVersion version, SecureRandom random) {
    ...
    public MyBCryptPasswordEncoder(BCryptPasswordEncoder.BCryptVersion version, int strength, SecureRandom random) {
    ...
    /*@Override
    public String getDecodePassword(String encodedPassword) {
        return null;
    }*/
